<template>
  <div>
    <div class="search-bar">
      ...
      <el-input v-model="filterData.targetId" placeholder="编号" size="mini">
        <template slot="prepend">
          电话
        </template>
      </el-input>
...
<script>
  ...
  import {getFundNeedInByTarget,getFundNeedInByTargetOrder} from '@/service/PurchaseAndSale/Fund/CheckCope.js'
  ...
  export default {
    ...
    methods: {
      ...
      readRow(index,row){
        ...
        getFundNeedInByTargetOrder(params).then(res => {
      ...
      getNeedFundList() {
        ...
        getFundNeedInByTarget(params).then(res => {
