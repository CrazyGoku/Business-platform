  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'OtherEntry',
          component: () => import('@/views/PurchaseAndSale/Fund/Pages/OtherEntry.vue'),
          name: 'OtherEntry',
          meta: { title: '其他收入', iconfont: '&#xe631;', roles: [63] }
        },
        {
          path: 'OtherOut',
          component: () => import('@/views/PurchaseAndSale/Fund/Pages/OtherOut.vue'),
          name: 'OtherOut',
          meta: { title: '其他支出', iconfont: '&#xe631;', roles: [64] }
        },
        {
          path: 'WithdrawalOrder',
          component: () => import('@/views/PurchaseAndSale/Fund/Pages/WithdrawalOrder.vue'),
          name: 'WithdrawalOrder',
          meta: { title: '提现申请审核', iconfont: '&#xe631;', roles: [65] }
        }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'Message',
          component: () => import('@/views/PurchaseAndSale/Marketing/Pages/Message.vue'),
          name: 'Message',
          meta: { title: '短信管理', iconfont: '&#xe631;', roles: [66] }
        }
      ]
    },
    {
      ...
      children: [
        ...
        {
          path: 'PurchaseReport',
          component: () => import('@/views/PurchaseAndSale/Report/Pages/PurchaseReport.vue'),
          name: 'PurchaseReport',
          meta: { title: '采购报表', iconfont: '&#xe631;', roles: [62] }
        },
        {
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'Label',
          component: () => import('@/views/PurchaseAndSale/DataEditing/Label/Label.vue'),
          name: 'Label',
          meta: { title: '商品标签', iconfont: '&#xe611;', roles: [61] }
        },
        {
          path: 'VIPCustomer',
    ...
    },
    {
      path: 'Store',
      name: 'Store',
      component: () => import('@/views/PurchaseAndSale/Store/Store.vue'),
      meta: { title: '商城管理', iconfont: '&#xe671;', roles: [74] },
      redirect: 'noredirect',
      children: [
        {
          path: 'SearchOrder',
          component: () => import('@/views/PurchaseAndSale/Store/Pages/SearchOrder.vue'),
          name: 'SearchOrder',
          meta: { title: '查询订单', iconfont: '&#xe631;', roles: [75] }
        },
        {
          path: 'SearchOrderReturn',
          component: () => import('@/views/PurchaseAndSale/Store/Pages/SearchOrderReturn.vue'),
          name: 'SearchOrderReturn',
          meta: { title: '查询售后订单', iconfont: '&#xe631;', roles: [76] }
        },
        {
          path: 'regionManager',
          component: () => import('@/views/PurchaseAndSale/Store/Pages/regionManager.vue'),
          name: 'regionManager',
          meta: { title: '商城管理', iconfont: '&#xe631;', roles: [77] }
        },
        {
          path: 'drawManager',
          component: () => import('@/views/PurchaseAndSale/Store/Pages/drawManager.vue'),
          name: 'drawManager',
          meta: { title: '抽奖设置', iconfont: '&#xe631;', roles: [78] }
        },
        {
          path: 'drawHistory',
          component: () => import('@/views/PurchaseAndSale/Store/Pages/drawHistory.vue'),
          name: 'drawHistory',
          meta: { title: '抽奖记录', iconfont: '&#xe631;', roles: [79] }
        }
      ]
    }
