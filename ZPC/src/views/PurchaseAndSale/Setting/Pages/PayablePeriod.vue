...
export default {
  ...
  data() {
    return {
      ...
      suppliersList: [],
      opening: {
        advanceOutMoneyOpening: 0,
        needOutMoneyOpening: 0
      },
      choiceRow: {}
    }
  },
  ...
  methods: {
    ...
    settingHandle(index, row) {
      this.choiceRow = row
      this.opening = {
        advanceOutMoneyOpening: this.choiceRow.advanceOutMoneyOpening,
        needOutMoneyOpening: this.choiceRow.needOutMoneyOpening
      }
