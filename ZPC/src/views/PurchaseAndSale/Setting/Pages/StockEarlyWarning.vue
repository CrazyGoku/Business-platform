  ...
  <div>
    ...
    >
      ...
      <div class="dialog-content-input">
        <NumberInput v-show="openStatus" v-model="inventoryDetail.inventoryUpperLimit" min="-1000">
          <template slot="prepend">
            库存上限
          </template>
        </NumberInput>
        <NumberInput v-show="openStatus" v-model="inventoryDetail.inventoryLowLimit" min="-1000">
          <template slot="prepend">
            库存下限
          </template>
        </NumberInput>
