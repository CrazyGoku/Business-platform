...
export default {
  ...
  mixins: [common, clientsList, warehouseList],
  data() {
    return {
      inUseGood: [],
      outUseGood: [],
  ...
  methods: {
    moneyChange(row) {
      ...
      this.amountReceivable = outTotalMoney - inTotalMoney
    },
    deleteInChoiceRow(index, row) {
      this.choiceInGoodsSku = this.choiceInGoodsSku.filter((v, _index) => {
        return index !== _index
      })
      let inTotalMoney = 0
      let outTotalMoney = 0
    ...
    deleteOutChoiceRow(index, row) {
      this.choiceOutGoodsSku = this.choiceOutGoodsSku.filter((v, _index) => {
        return index !== _index
      })
      let inTotalMoney = 0
      let outTotalMoney = 0
    ...
    comfirm() {
      ...
      console.log(this.chioceSelect.clientId)
      ...
      data.totalMoney = totalOutMoney - totalInMoney
      data.orderMoney = totalOutMoney - totalInMoney
