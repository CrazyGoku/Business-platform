...
import { getSellApply, getSellApplyDetails } from '@/service/PurchaseAndSale/Sale/common.js'
    ...
    printFun() {
      ...
      const routeData = this.$router.resolve({
        ...
        query: {
          ...
          clientName: this.clientDetail ? this.clientDetail.name : '',
          clientPhone: this.clientDetail ? this.clientDetail.phone : '',
          clientAddr: this.clientDetail ? this.clientDetail.address : ''
        }
      })
