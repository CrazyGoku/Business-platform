...
import { getGoodSkuPrice } from '@/service/PurchaseAndSale/common'
    ...
    choiceGoodsSkuFun(value) {
      ...
      if (this.followPriceStatus) {
        ...
        getGoodSkuPrice(params).then(res => {
          ...
          const data = this.goodsSkuVos.filter(v => {
            return v.id == value
          })[0]
          ...
          _data.goodName = _data.goodName
          _data.money = fallowPrice || (_data[this.priceTypeMap[this.choiceClient.clientLevel.priceType]] * this.choiceClient.clientLevel.price).toFixed(2)
          _data.discountMoney = 0
          _data.remark = ''
          _data.totalMoney = (_data[this.priceTypeMap[this.choiceClient.clientLevel.priceType]] * this.choiceClient.clientLevel.price).toFixed(2)
        ...
        _data.goodsSkuId = _data.id
        _data.goodName = _data.goodName
        _data.money = (_data[this.priceTypeMap[this.choiceClient.clientLevel.priceType]] * this.choiceClient.clientLevel.price).toFixed(2)
        _data.discountMoney = 0
        _data.remark = ''
        _data.totalMoney = (_data[this.priceTypeMap[this.choiceClient.clientLevel.priceType]] * this.choiceClient.clientLevel.price).toFixed(2)
        this.choiceGoodsSku.push(_data)
