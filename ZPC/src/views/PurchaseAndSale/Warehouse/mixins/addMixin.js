import { getGoodsCheck } from '../../../../service/PurchaseAndSale/common'
  ...
  methods: {
    ...
    choiceGoodsSkuFun(value) {
      ...
      const params = {
        ...
        goodsSkuId: value,
        warehouseId: this.chioceSelect.outWarehouseId ? this.chioceSelect.outWarehouseId : this.chioceSelect.inWarehouseId
      }
      getGoodsCheck(params).then(res => {
        _data.checkQuantity = res.data.data.checkQuantity
        _data.checkMoney = res.data.data.checkMoney
        _data.checkTotalMoney = res.data.data.checkTotalMoney
