        ...
        >
          <template slot-scope="scope">
            <el-button
              type="text"
              size="small"
              @click.native.prevent="oneHandle(scope.$index,scope.row);createTime = ''"
            >
              付款
            </el-button>
            <el-button
...
export default {
  ...
  methods: {
    ...
    confirmHandle() {
      ...
      const totalMoney = Number(this.payParams.money) + Number(this.payParams.discountMoney) + Number(this.payParams.advanceMoney)
