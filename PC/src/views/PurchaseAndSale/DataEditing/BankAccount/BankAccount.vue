<template>
  <div>
    <div class="handle-bar">
      <el-button type="primary" icon="el-icon-circle-plus-outline" size="mini" @click="dialogVisible1 = true; dialogTitle1 = '添加银行账户';isEdit = false">
        添加
      </el-button>
...
export default {
  ...
  data() {
    return {
      ...
      typeOption: [{ name: '现金', id: 1 }, { name: '银行卡', id: 2 }, { name: '支付宝', id: 3 }, { name: '微信', id: 4 }],
