<template>
  <div>
    <div class="handle-bar">
      <el-button type="primary" icon="el-icon-circle-plus-outline" size="mini" @click="dialogVisible1 = true; dialogTitle1 = '添加供应商';isEdit = false">
        添加
      </el-button>
    ...
    >
      <div class="dialog-content-input">
        ...
        <el-input v-model="supplierDetail.contactNumber" placeholder="请输入联系电话" size="mini">
          <template slot="prepend">
            联系电话
          </template>
        </el-input>
...
import { getSupplierData, postSupplierData, delSupplierData, findSupplierById, putSupplierData } from '@/service/PurchaseAndSale/DataEditing/Supplier.js'
