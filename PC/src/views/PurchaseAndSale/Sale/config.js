...
export const retailDetailMap = [
  { key: 'goodsName', name: '商品名称' },
  { key: 'discountMoney', name: '折扣价' },
  { key: 'goodsBarCode', name: '条形码' },
  { key: 'goodsId', name: '商品ID' },
  { key: 'goodsSkuSku', name: '规格' },
  { key: 'money', name: '价格' },
  { key: 'goodsSkuRetailPrice', name: '零售价' },
  { key: 'goodsSkuVipPrice', name: 'VIP售价' },
  { key: 'orderId', name: '订单ID' },
  { key: 'quantity', name: '数量' },
  { key: 'remark', name: '备注' }
]
export const addRetailMap = [
