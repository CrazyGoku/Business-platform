<template>
  <div>
    <div class="search-bar">
      <el-input @clear="getStorageInventoryCurrentFun" clearable v-model="filterData.id" placeholder='商品货号' size="mini">
        <template slot="prepend">商品货号</template>
      </el-input>
      <el-input @clear="getStorageInventoryCurrentFun" clearable v-model="filterData.name" placeholder='商品名称'
                size="mini">
    ...
    <el-dialog :close-on-click-modal="false"
      ...
      width="80%">
      <select-table v-if="dialogType===3"  :data="skuList" :pagination-data="paginationData2"
