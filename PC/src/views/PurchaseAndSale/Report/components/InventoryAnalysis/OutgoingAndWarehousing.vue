...
<script>
  ...
  import {getReportInventoryAnalysisByDetails} from '@/service/PurchaseAndSale/Report/InventoryAnalysis.js'
  import SelectTable from '@/components/SelectTable/SelectTable'// 列表组件
  import commodityTypeList from '@/mixins/commodityTypeList.js'
  import { parseTime } from '@/utils'
  export default {
    name: 'OutgoingAndWarehousing',
    ...
    methods: {
      ...
      getInventoryList(){
        ...
        getReportInventoryAnalysisByDetails(params).then(res=>{
