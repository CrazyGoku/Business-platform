  ...
  methods: {
    ...
    choiceGoodsSkuFun(value) {
      ...
      this.choiceGoodsSku.forEach(v => {
        ...
        this.$set(v, 'money', this.choiceClient.clientLevel.priceType == 1 ? (v.retailPrice * this.choiceClient.clientLevel.price).toFixed(2) : (v.vipPrice * this.choiceClient.clientLevel.price)).toFixed(2)
